...
public class App {
    ...
    public static void runSets() {
        ...
        Set<String> contruirTreeSet = setsClases.construirTreeSetConComparador();
        System.out.println(contruirTreeSet);
        System.out.println(contruirTreeSet.size());

        Set<Person> personas = setsClases.personsTreeSet();
        System.out.println(personas);
        System.out.println(personas.size());
        //System.out.println("Ana".compareTo("Andres"));
    }
    ...
    public static void runMaquina() {
        ...
        Set<Maquina> maquinasO = controller.ordenarPerSubred(maquinas);
        for (Maquina maquina : maquinasO) {
            System.out.println(maquina.getSubred() + " - " + maquina.getName());
        }
